							...
							<div class="col-lg-4 mb-4 p-2 ml-0">
								<div class="entry2 border">
									<a href="<?= base_url('viewblog/').$b->slug_blog ?>">
										<img src="<?= base_url('imblog/').$b->gambar_blog ?>" alt="Image" class="img-fluid mx-auto d-block" width="850px">
									</a>
									<div class="excerpt">
									...
									<div class="post-meta align-items-center text-left clearfix">
										<figure class="author-figure mb-0 mr-3 float-left"><img src="<?= base_url('profil/').$b->img_profil ?>" alt="Image" class="img-fluid"></figure>
