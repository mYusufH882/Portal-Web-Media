...
<body>
  ...
  <div class="site-wrap">
    ...
    <?php if($tentang['gambar_simpul'] == '') { ?>
      <div class="site-cover site-cover-sm same-height overlay single-page" style="background-image: url('<?= base_url() ?>gmtentang/img.jpg');">
    <?php } else { ?>
      <div class="site-cover site-cover-sm same-height overlay single-page" style="background-image: url('<?= base_url('gmtentang/').$tentang['gambar_simpul'] ?>');">
    <?php } ?>
      <div class="container">
