...
<div class="site-wrap">
    ...
    <?php $this->load->view('component/navbar', $getKategori); ?>
        ...
        <div class="py-5" style="background-image: url('<?= base_url() ?>assets/img/img.jpg'); background-position:bottom;">
            <div class="container">
                <div class="row">
                    ...
                    <?php foreach($kategoriBlog->result() as $kb) { ?>
                        <div class="col-lg-4 mb-4 border p-2 ml-2">
                            ...
                            <a href="<?= base_url('viewblog/').$kb->slug_blog ?>">
                               <img src="<?= base_url('imblog/').$kb->gambar_blog; ?>" width="1500px" alt="Image" class="img-fluid rounded">
                            </a>
                            <div class="excerpt">
